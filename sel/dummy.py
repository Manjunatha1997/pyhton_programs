...
driver = webdriver.Firefox(executable_path='D:\\python_programs\\sel\\geckodriver')
...
driver.find_element_by_xpath('/html/body/app-my-app/app-layout/div[1]/div[2]/div/app-parts-page/div[1]/div/input').send_keys('Fod_prepreg')
