...
from tqdm.notebook import tqdm  # To show the progress bar for each epoch
import torch.nn.functional as F



DATA_DIR = r'D:\python_programs\data'
...
def fit(epochs, lr, start_idx=1):
    ...
    # Mert: first beta, ß_1: exponential decay hyperparameter for the first moment estimates
    # It's 0.9 by default but changed to 0.5 because we want to average the gradient over last ~2 weights
    # instead of 10. Averaging over just 2 weights is noisier but it quickly adapts to current changes as well.
    # For more information, Google: "Exponentially Weighted Averages" or "Moving/Running Average"
    for epoch in range(epochs):
        ...
        print("Epoch [{0}/{1}]: loss_g: {2:.4f}, loss_d: {3:.4f}, real_score: {4:.4f}, fake_score: {5:.4f}".format(
